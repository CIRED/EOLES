...
class ModelEOLES():
    ...
    def define_sets(self):
        ...
        self.model.elec_prod = Set(initialize=["offshore_float", "offshore_ground", "onshore", "pv_ground_S", "pv_ground_EW", "pv_roof_com_S", "pv_roof_com_EW", "pv_roof_indiv_S", "pv_roof_indiv_EW",
                                               "river", "lake", "nuclear", "coal", "biomass_coge", "geothermal_coge", "waste", "marine", "ocgt_coge", "methanization_coge"])
        self.model.CH4_prod = Set(initialize=["pyrogazification", "methanation", "natural_gas", "methanization_injection"])
        ...
        self.model.use_elec = Set(initialize=["phs", "battery_1h", "battery_4h", "electrolysis", "methanation", "str_dummy", "methanization", "methanization_coge", "methanization_injection"])
        ...
        self.model.conversion_tech = Set(initialize=["ch4_ocgt", "ch4_ccgt", "h2_ccgt", "electrolysis", "methanation", "methanization"])
        self.model.double_conversion_tech = Set(initialize=["methanization_coge", "methanization_injection"])
